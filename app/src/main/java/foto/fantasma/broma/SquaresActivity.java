...
//cambiatu			
        ...
        if (extra == null) {
            ...
            toast1.show();
//cambiatu				
            Intent myIntent = new Intent(SquaresActivity.this, MenuP.class);
            int o = 1;
        ...
        if (fechaDia.equalsIgnoreCase(ssaammdd)) {
            ...
            if (fechaDia != "0001") {
                toast1 = Toast.makeText(getApplicationContext(), "Error: package" + fechaDia, Toast.LENGTH_SHORT);
                toast1.show();
                Intent myIntent = new Intent(SquaresActivity.this, MenuP.class);
                int o = 1;
                myIntent.putExtra("orientacion", o);
...
//cambiatu recalculamos las dimensiones de la foto sin alterar las de la pantalla
                    if (hPantalla2 > TAMANO_MAX) {
                        wPantalla2 = TAMANO_MAX * wPantalla / hPantalla;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	  ...
	  case R.id.exit:
	   // Acciones
		  canvasView.surfaceDestroyed(null);
		  finish();
		  //Intent myIntent = new Intent(SquaresActivity.this, Puntualo.class);
